...
return [
    ...
    'users' => [
        ...
        'owner_role' => 'owner',
         ...
         // The name of the Operational role
        'operational_manager_role' => 'operational_manager',

         // The name of the Operational role
        'operational_staff_role' => 'operational_staff',

         // The name of the Keuangan role
        'akunting_manager_role' => 'akunting_manager',
